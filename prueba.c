...
//Procedimiento para convertir la lista de objetivos en un string
char * objetivos_toString(objetivo *objetivos){
    objetivo *aux = objetivos;
    char * string;
    char * value1;
    char * value2;
    char * value3;
    while (aux != NULL){
        snprintf(value1, ,"%d",aux -> coord1);
        snprintf(value2, ,"%d",aux -> coord2);
        snprintf(value3, ,"%d",aux -> resistencia);

        string = strcat(string,value1);
    }
